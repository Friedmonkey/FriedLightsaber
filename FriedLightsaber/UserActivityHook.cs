...
namespace FriedLightsaber
{
    ...
    public class UserActivityHook
    {
        ...
        public delegate void MouseClickEventHandler(object sender, MouseButtons mouseButtons, bool down);
        public event MouseClickEventHandler OnMouseClickActivity;
        /// <summary>
        ...
        private int MouseHookProc(int nCode, int wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0) && (OnMouseActivity != null))
            {
                ...
                {
                    case WM_LBUTTONUP:
                        OnMouseClickActivity(this, MouseButtons.Left, false);
                        break;
                    case WM_RBUTTONUP:
                        OnMouseClickActivity(this, MouseButtons.Right, false);
                        break;
                    case WM_LBUTTONDOWN:
                        //case WM_LBUTTONUP: 
                        //case WM_LBUTTONDBLCLK: 
                        button = MouseButtons.Left;
                        OnMouseClickActivity(this, button, true);
                        break;
                    case WM_RBUTTONDOWN:
                        //case WM_RBUTTONUP: 
